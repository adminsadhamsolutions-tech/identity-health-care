...
export default function Appointment() {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      setStatus({ type: 'error', message: 'Unable to submit appointment. Please try again.' });
    }
  };
  ...
  return (
    <section className="section" id="appointment">
      <div className="container text-center">
        <p style={{ color: '#6a1b9a', fontWeight: 700, marginBottom: '14px' }}>Book your consultation</p>
        ...
        <form className="form-grid" onSubmit={handleSubmit} style={{ maxWidth: '920px', margin: '0 auto' }}>
          ...
          <div className="form-block">
            <label>Phone</label>
            <input name="phone" type="tel" value={form.phone} onChange={handleChange} placeholder="8903660581" />
          </div>
          <div className="form-block">
            <label>Email</label>
          ...
          <div className="form-block">
            <label>Message</label>
            <textarea name="message" value={form.message} onChange={handleChange} placeholder="Tell us about your goals" />
          </div>
